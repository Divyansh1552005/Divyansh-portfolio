...
const Experience = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative bg-gradient-to-br from-gray-900 via-gray-900 to-blue-950/30 rounded-3xl border border-gray-700/50 overflow-hidden shadow-2xl">
          {/* Decorative gradient overlay */}
          <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 via-transparent to-purple-500/5 pointer-events-none"></div>
          
          {/* Glowing effect on hover */}
          <div className="absolute -inset-[1px] bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-blue-500/20 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl"></div>
          ...
          <div className="relative p-8 sm:p-12 lg:p-16">
            ...
            >
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-blue-500 to-blue-600 p-5 rounded-2xl">
            ...
            >
              <h3 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white mb-4 bg-gradient-to-r from-white via-blue-100 to-white bg-clip-text text-transparent">
                Open to New Opportunities
              </h3>
              <div className="inline-block px-6 py-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/30 rounded-full">
            ...
            >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-3xl mx-auto">
                {skills.map((skill, index) => (
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-blue-500 rounded-xl opacity-0 group-hover:opacity-100 blur transition-opacity duration-300"></div>
                    <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 group-hover:border-blue-500/50 rounded-xl px-4 py-3 text-center transition-all duration-300">
